...
<!--            </el-upload>-->
        ...
        <el-dialog title="用户信息" :visible.sync="dialogFormVisible" width="35%">
            <el-form  label-width="100px" size="small" :model="form" :rules="addFormRules" ref="ruleForm">
                ...
                <el-form-item label="是否为本小区人员" prop="localPeople">
                    <el-radio-group v-model="form.localPeople" disabled>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            //用户删除按钮
            handleDelete(id){
                request.delete("/resident/"+ id).then(res =>{
                    //判断是否保存成功
                    if(res) {
          ...
          load(){
            ...
            if (this.name == ""&&this.address==""){
              ...
              //执行模糊查询
              this.request.get("/resident/localPage",{
                    params:{
                      pageNum:this.pageNum,
                      pageSize:this.pageSize,
                      name:this.name,
